...
namespace UnityEngine.Perception.GroundTruth
{
    ...
    public partial class PerceptionCamera : MonoBehaviour
    {
        ...
        public string k_RgbFilePrefix = "rgb_";
        ...
        internal string rgbDirectory { get; } = "RGBImages";//$"RGB{Guid.NewGuid()}";
        ...
        /// <summary>
        /// Quality level for JPG files (default 100)
        /// </summary>
        [Range(1, 100)]
        ...
        void Start()
        {
            imageName = Camera.main.GetComponent<ImageName>();

            collision = Camera.main.GetComponent<CollisionDetection>();
        ...
        void CaptureRgbData(Camera cam)
        {
            ...
            k_RgbFilePrefix = imageName.imageName;
            var fileExtension = saveAsJPG ? ".jpg" : ".png";
            var captureFilename = $"{Manager.Instance.GetDirectoryFor(rgbDirectory)}/{k_RgbFilePrefix}{fileExtension}"; // {Time.frameCount}{fileExtension}";
            var dxRootPath = $"{rgbDirectory}/{k_RgbFilePrefix}{fileExtension}"; //{Time.frameCount}{fileExtension}";
