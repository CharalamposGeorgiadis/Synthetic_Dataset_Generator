...
namespace UnityEngine.Perception.GroundTruth
{
    partial class SimulationState
    {
        ...
        List<PendingCapture> m_PendingCaptures = new List<PendingCapture>();
       ...
       // CustomSampler m_SerializeMetricsAsyncSampler = CustomSampler.Create("SerializeMetricsAsync");
        ...
        public int k_MinPendingCapturesBeforeWrite = 0;//150;
        //  const int k_MinPendingMetricsBeforeWrite = 150;//150;
    ...
    //    {
     ...
     //   }
        ...
        public void Update()
        {
            ...
            {
                // Means no sensor is controlling simulation timing, so we set Time.captureDeltaTime to 0 (default),
                // which means the setting does not do anything
                nextFrameDt = 0;
            }
